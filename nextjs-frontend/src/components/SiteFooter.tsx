      ...
      <div className="container-page py-16 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-1">
          <div className="flex items-center gap-3">
            <img src={logo.src} alt="Ramani Foundation" className="h-12 w-12" />
            <div>
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm text-muted-foreground">
            ...
            <li><Link href="/contact" className="hover:text-foreground">Volunteer</Link></li>
            <li><Link href="/contact" className="hover:text-foreground">Partner with Us</Link></li>
