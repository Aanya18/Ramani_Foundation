...
export default function ContactPage() {
  ...
  const defaultMessage = searchParams.get("amount")
    ? `I would like to donate ₹${Number(searchParams.get("amount")).toLocaleString()}. Please contact me with the next steps.`
    : "";
