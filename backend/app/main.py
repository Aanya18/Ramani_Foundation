...
from .api import public_auth_router, public_event_router, public_gallery_router, public_lead_router, public_donation_router, public_images_router, private_event_router, private_gallery_router, private_lead_router, private_donation_router
